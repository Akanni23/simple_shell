...
/**
 * _myhistory - Display the history list, one command per line, preceded
...
/**
 * unset_alias - Set an alias to an empty string.
...
/**
 * _myalias - Mimic the alias built-in (man alias).
 * @info: A structure containing potential arguments. Used to maintain
 *        a constant function prototype.
 * Return: Always 0.
 */
